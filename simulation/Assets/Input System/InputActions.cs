...
public partial class @InputActions: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": [
        ...
        m_Reset_ResetButton = m_Reset.FindAction("ResetButton", throwIfNotFound: true);
    }
    ...
    ~@InputActions()
    {
        ...
        Debug.Assert(!m_Reset.enabled, "This will cause a leak and performance issues, InputActions.Reset.Disable() has not been called.");
    }
    ...
    {
        private @InputActions m_Wrapper;
        public ResetActions(@InputActions wrapper) { m_Wrapper = wrapper; }
